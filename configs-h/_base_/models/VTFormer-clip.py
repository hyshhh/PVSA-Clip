...
model = dict(
    ...
    backbone=dict(
        ...
        topks=[16, 12, 8, 6],
        topp_route_configs={
            16: dict(maxk=25, p=0.2, temperature=0.0175, energy=2.0),
            12: dict(maxk=18, p=0.4, temperature=0.025, energy=2.0),
            8: dict(maxk=36, p=0.6, temperature=0.05, energy=2.0),
            6: dict(maxk=49, p=0.8, temperature=0.15, energy=2.0),
        },
        side_dwconv=5,
